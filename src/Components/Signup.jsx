...
export default function Signup() {
    ...
    let [errorMessage, setErrorMessage] = useState({
        ...
        phone: "Phone No field is mandatory",
            ...
            <div className='container-fluid my-5'>
                ...
                <div className="row">
                    <div className="col-md-8 col-sm-10 col-12 m-auto">
                        <h5 className='bg-primary text-light p-2 text-center'><strong>Create</strong> a Free Account</h5>
                        <form onSubmit={postData}>
                            <div className="row">
                                <div className="col-md-6 mb-3">
                                    <label>Name</label>
                                    <input type="text" name="name" onChange={getInputData} className='form-control' placeholder='Full Name' />
                                    {show ? <p className='text-capatalize px-2'>{errorMessage.name}</p> : ""}
                                </div>
                                <div className="col-md-6 mb-3">
                                    <label>User Name</label>
                                    <input type="text" name="username" onChange={getInputData} className='form-control' placeholder='User Name' />
                                    {show ? <p className='text-capatalize px-2'>{errorMessage.username}</p> : ""}
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-md-6 mb-3">
                                    ...
                                    {show ? <p className='text-capatalize px-2'>{errorMessage.email}</p> : ""}
                                </div>
                                <div className="col-md-6 mb-3">
                                    <label>Phone</label>
                                    <input type="text" name="phone" onChange={getInputData} className='form-control' placeholder='Phone Number' />
                                    {show ? <p className='text-capatalize px-2'>{errorMessage.phone}</p> : ""}
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-md-6 mb-3">
                                    <label>Password</label>
                                    <input type="password" name="password" onChange={getInputData} autoComplete="new-password" className='form-control' placeholder='Password' />
                                    {show ? <p className='text-capatalize px-2'>{errorMessage.password}</p> : ""}
                                </div>
                                <div className="col-md-6 mb-3">
                                    <label>Confirm Password</label>
                                    <input type="password" name="cpassword" onChange={getInputData} autoComplete="new-password" className='form-control' placeholder=' Confirm Password' />
                                    {show ? <p className='text-capatalize px-2'>{errorMessage.password}</p> : ""}
                                </div>
                            </div>
                            <div className="mb-3">
