            ...
            <div className="container-fluid my-5">
                ...
                <div className="row">
                    <div className="col-md-6">
                        <ProfileTable user={user} heading="Billing Address" buttonText="Update Billing Address" />
                    </div>
                    <div className="col-md-6">
                        <h5 className='bg-primary text-center text-light p-2'>Cart Section</h5>
                        {
                            cart.length ?
                                <>
                                    ...
                                    <table className='table table-bordered'>
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>Payment Mode</th>
                                                <td><select name="mode" onChange={(e)=>setMode(e.target.value)} className='form-select'>
