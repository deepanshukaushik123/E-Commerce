      ...
      <div className="container-fluid my-2">
        <div className="row">
          ...
          <div className="col-md-9">
            <h5 className='bg-primary p-2 text-center'>UpdateProduct  <button onClick={() => window.history.back()} className='btn btn-secondary text-light'>Back</button></h5>
            <div className="mb-3">
              <form onSubmit={postData}>
                <div className="mb-3">
                  <label>Name<span className='text-danger'>*</span></label>
                  <input type="text" name='name' onChange={getInputData} value={data.name} placeholder='Product Name' className='form-control mt-1' />
                ...
                <div className="row">
                  <div className="col-md-6 mb-3">
                    ...
                    {show ? <p className='text-danger text-capitalize'>{errorMessage.color}</p> : ""}
                  </div>
                  <div className="col-md-6 mb-3">
                    ...
                    {show ? <p className='text-danger text-capitalize'>{errorMessage.size}</p> : ""}
                  </div>
                </div>
                <div className="row">
                  <div className="col-md-6 mb-3">
                    ...
                    {show ? <p className='text-danger text-capitalize'>{errorMessage.baseprice}</p> : ""}
                  </div>
                  <div className="col-md-6 mb-3">
                    ...
                    {show ? <p className='text-danger text-capitalize'>{errorMessage.discount}</p> : ""}
                  </div>
                </div>
                ...
                <div className="mb-3">
                  ...
                  <input type="file" name="pics" onChange={getInputFiles} multiple className='form-control' />
