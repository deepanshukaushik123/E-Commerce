      ...
      <div className="container-fluid my-2">
        <div className="row">
          ...
          <div className="col-md-9">
            <h5 className='bg-primary p-2 text-center'>CreateProduct  <button onClick={() => window.history.back()} className='btn btn-secondary text-light'>Back</button></h5>
            <div className="mb-3">
              <form onSubmit={postData}>
                ...
                <div className="mb-3">
                  ...
                  {show ? <p className='text-danger text-capitalize'>{errorMessage.pic}</p> : ""}
