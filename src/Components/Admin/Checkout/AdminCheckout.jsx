...
export default function AdminCheckout() {
  const columns = [
    ...
    { field: 'subtotal', headerName: 'Sub Total', width: 100, renderCell:({row})=><span>&#8377;{row.subtotal}</span>},
    { field: 'shipping', headerName: 'Shipping', width: 100, renderCell:({row})=><span>&#8377;{row.shipping}</span>},
    { field: 'total', headerName: 'Total', width: 100, renderCell:({row})=><span>&#8377;{row.total}</span>},
