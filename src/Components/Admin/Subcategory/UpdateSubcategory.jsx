  ...
  function getInputData(e) {
   ...
   function getAPIData() {
    ...
    if (SubcategoryStateData.length) {
      setSubcategoryData(SubcategoryStateData.reverse())
      ...
      <div className="container-fluid my-2">
        <div className="row">
          ...
          <div className="col-md-9">
            <h5 className='bg-primary p-2 text-center'>UpdateSubcategory  <button onClick={() => window.history.back()} className='btn btn-secondary text-light'>Back</button></h5>
            <div className="mb-3">
